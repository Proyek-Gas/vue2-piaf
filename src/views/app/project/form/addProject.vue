...
<b-row>
        ...
        <b-form @submit.prevent="onValitadeFormSubmit" class="av-tooltip tooltip-label-right">
            <b-card class="mb-4" title="Profil Project">
                ...
                <b-form-group label-cols="3" horizontal label="Kategori">
                    <v-select v-model="katPro" :options="katProOption" label="name" @input="test" placeholder="Pilih kategori"/>
                </b-form-group>
    ...
    <b-colxx xxs="12" xl="4" class="col-right">
            <b-card class="mb-4" style="position: sticky; top: 20vh">
                ...
                <b-row>
                    <b-colxx xxs="8">
                        <p v-if="katPro != ''" class="mb-3">{{ katPro.name }}</p>
...
export default {
    ...
    methods: {
        ...
        onFormReset(){
            this.customer = "";this.custNama=""; this.custPhone="";this.namaPro = "";this.tglPro = "";this.katPro = "";
            this.$v.$reset();
        },
