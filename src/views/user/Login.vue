    ...
    <b-colxx xxs="12" md="10" class="mx-auto my-auto">
        <b-card class="auth-card" no-body>
            <div class="position-relative image-side">
                ...
                <p class="text-white h2">QUOTATION</p>
                <p class="white mb-0">
            ...
            <div class="form-side">
                ...
                <b-form @submit.prevent="formSubmit" class="av-tooltip tooltip-label-bottom">
                    <b-form-group :label="$t('user.phone')" class="has-float-label mb-4">
                        ...
                        <b-form-invalid-feedback v-if="!$v.form.phone.required">Please enter your phone number</b-form-invalid-feedback>
                    </b-form-group>
...
import { adminRoot,isAuthGuardActive } from '../../constants/config';
